...
import java.awt.*;
/* <applet code="PersonalAndAcademic.class" width=500 
height=500> </applet> */
public class PersonalAndAcademic extends JApplet 
{
    ...
    {
        JLabel jlblFirstName, jlblLastName, jlblMobNo, 
        jlblEmail, jlblGender, jlbl;
        JTextField jtxtFirstName, jtxtLastName, 
        jtxtMobNo, jtxtEmail;
        ButtonGroup bg;
        ...
        public PersonalPanel()
        {
            ...
            String state[] = 
            {"Maharashtra","Goa","Panjab","Karnatak","Gujrat"};
        ...
        class AcademicPanel extends JPanel
        {
            AcademicPanel()
            {
                ...
                JLabel jlblCourse, jlblEnrollNo, jlblPer, 
                jlblCreadits, jlbl;
                JTextField jtxtPer, jtxtCreadits, 
                jtxtEnrollNo;
                JCheckBox jchkProject, jchkDM, 
                jchkJava, jchkAndroid;
